angular.module('driveme')
  ...
  .controller('ModalCtrl', function($rootScope, $scope, $log, $uibModal) {
...
angular.module('driveme').controller('ModalInstanceCtrl', function($scope, $uibModalInstance, modalFactory) {
...
angular.module('driveme').controller('ModalResultInstanceCtrl', function($scope, $uibModalInstance, params) {
